      ...
      >
        {status === "verifying" && (
          <>
            ...
            <p className="mt-2 text-sm" style={{ color: "#8b9ab0" }}>This will only take a moment.</p>
          </>
        )}
        {status === "success" && (
          <>
            <p className="text-lg font-semibold" style={{ color: "#00d68f" }}>Email verified!</p>
            <p className="mt-2 text-sm" style={{ color: "#8b9ab0" }}>Your account is now fully activated.</p>
            <Link
              href="/app"
        ...
        {status === "error" && (
          <>
            ...
            <p className="mt-2 text-sm" style={{ color: "#8b9ab0" }}>{errorMessage}</p>
            <Link
              href="/app"
