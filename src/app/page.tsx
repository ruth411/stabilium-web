    ...
    <div className="min-h-screen">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <article key={f.title} className="glow-card rounded-2xl p-6">
                ...
                <h3 className="mb-2 font-bold" style={{ color: "#eef2f7" }}>{f.title}</h3>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {STEPS.map((step, i) => (
              <article key={step.n} className="glow-card relative rounded-2xl p-7">
                {i < STEPS.length - 1 && (
                  <span className="absolute -right-2 top-8 hidden text-xl lg:block" style={{ color: "rgba(255,255,255,0.2)" }}>
                    →
                  </span>
                )}
                ...
                <h3 className="mb-2 text-xl font-bold" style={{ color: "#eef2f7" }}>{step.title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: "#d4d4d4" }}>
                  {step.body}
                </p>
              </article>
        ...
        <section id="demo" className="py-16">
          ...
          <div className="mx-auto max-w-3xl rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", backdropFilter: "blur(16px)" }}>
            <form onSubmit={runEval} className="space-y-5">
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block text-sm">
                  <span className="mb-2 block font-medium" style={{ color: "#eef2f7" }}>
                    Provider
                  </span>
                  <select
                    value={provider}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-medium" style={{ color: "#eef2f7" }}>
                    Number of cases
                  </span>
                ...
                {result && (
                  <div className="space-y-5">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <p className="font-bold" style={{ color: "#eef2f7" }}>{result.model}</p>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {PRICING.map((plan) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold" style={{ color: "#eef2f7" }}>{plan.name}</h3>
